window.addEventListener("load", async () => {
    ...
    async function sendJson() {
        ...
        // Validação, mas o Flask usa o endpoint na URL
        if (!endpoint) {
             // Se o JSON não tem 'comando', tentamos /register por padrão
             endpoint = '/register'; 
        ...
        // Concatena a URL base do ngrok com o endpoint
        ...
        try {
            ...
            responseBox.textContent = `✅ Resposta do servidor (${res.status}):\n${text}`;
            jsonInput.value = "";
        } catch (err) {
